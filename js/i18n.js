...
const I18n = (() => {
  const LOCALES = {
    ru: {
      ...
      'options.sync.token.expired': 'Токен Яндекс.Диска устарел или недействителен. Введите новый токен.',
    ...
    en: {
      ...
      'options.sync.token.expired': 'Yandex Disk token expired or invalid. Please enter a new token.',
    ...
    zh: {
      ...
      'options.sync.token.expired': 'Yandex Disk 令牌已过期或无效。请输入新令牌。',
